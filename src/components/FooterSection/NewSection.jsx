...
const NewSection = () => {
    return (
        <>
            <section className="container mx-auto mb-20 p-4 md:grid md:grid-cols-3 md:gap-8">
                <div className="grid grid-cols-[1fr_2fr] gap-4 pb-8  ">
                    ...
                    <div className="grid grid-rows-3">
                        ...
                        <h3 className="h-auto text-[1.4rem] font-extrabold">
                            Reviving Retro PCs
                        </h3>
                ...
                <div className="grid grid-cols-[1fr_2fr] gap-4 pb-8  ">
                    ...
                    <div className="grid grid-rows-3">
                        ...
                        <h3 className="h-auto text-[1.1rem] font-extrabold">
